class PickHelper {
  ...
  pick(normalizedPosition, getAstrionomicalBodies, camera, time) {
    ...
    if (intersectedObjects.length) {
      ...
      this.pickedObject.material.color = new THREE.Color(
  ...
  openModal(positionX) {
    ...
    var rotationPeriodEarthDays = document.getElementById(
    ...
    equatorialRadius.innerHTML =
      AstronomicalBodiesNames[positionX].equatorialRadius;
    surfaceGravity.innerHTML =
      AstronomicalBodiesNames[positionX].surfaceGravity;
    rotationPeriodEarthDays.innerHTML =
      AstronomicalBodiesNames[positionX].rotationPeriodEarthDays;
    orbitalPeriod.innerHTML = AstronomicalBodiesNames[positionX].orbitalPeriod;
    meanOrbitVelocity.innerHTML =
      AstronomicalBodiesNames[positionX].meanOrbitVelocity;
    surfaceTemperature.innerHTML =
      AstronomicalBodiesNames[positionX].surfaceTemperature;
    atmoshpericConstituents.innerHTML =
      AstronomicalBodiesNames[positionX].atmoshpericConstituents;
